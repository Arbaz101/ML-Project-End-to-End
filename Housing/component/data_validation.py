...
class DataValidation:
  ...
  def is_train_test_file_exists(self):
    try:
      ...
      if not is_available:
        training_file = os.path.basename(self.data_ingestion_artifact.train_file_path)
        testing_file = os.path.basename(self.data_ingestion_artifact.test_file_path)
  ...
  def validate_dataset_schema(self) -> bool:
    try:
      ...
      # 3. Check value of ocean proximity whether acceptable or not
