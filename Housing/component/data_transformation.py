...
class DataTransformation:
  ...
  def initiate_data_transformation(self)->DataTransformationArtifact:
    try:
      ...
      logging.info(f"Train array is saved in the directory")
      save_numpy_array_data(file_path=transformed_test_file_path, array=test_arr)
      logging.info(f"Test array is saved in the directory")
      ...
      logging.info(f"Preprocessing pkl Object is saved in the diretory")
